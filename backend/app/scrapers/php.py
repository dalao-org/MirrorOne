...
class PHPScraper(BaseScraper):
    ...
    async def scrape(self) -> ScrapeResult:
        ...
        # Default covers all branches shipped with LNMP (older ones are scraped
        # from the releases archive page even if no longer actively developed)
        accepted_versions = self.settings.get("php_accepted_versions", [
            "5.3", "5.4", "5.5", "5.6",
            "7.0", "7.1", "7.2", "7.3", "7.4",
